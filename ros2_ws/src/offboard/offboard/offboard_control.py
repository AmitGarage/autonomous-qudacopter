...
class OffboardControl(Node):
    ...
    def timer_callback(self) -> None:
        ...
        if self.vehicle_status.nav_state == VehicleStatus.NAVIGATION_STATE_OFFBOARD and self.square_check == 0:
            ...
            if round(self.vehicle_local_position.z,0) == self.takeoff_height :
            ...
            self.publish_position_setpoint(self.forward_distance_x, 0.0, self.takeoff_height)
            ...
            self.publish_position_setpoint(self.forward_distance_x, self.forward_distance_y, self.takeoff_height)
            ...
            self.publish_position_setpoint(0.0, self.forward_distance_y, self.takeoff_height)
